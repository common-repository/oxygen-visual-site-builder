	...
	<div id="ct-toolbar" class="ct-toolbar" 
		...
		<div id="ct-toolbar-main" class="clearfix">
			...
			<div class="ct-toolbarsection ct-toolbarsection-two">
				...
				<span ng-show="!isEditing('style-sheet')">
					<?php do_action("oxygen_vsb_toolbar_component_header"); ?>
				</span>
			</div>
			...
			<div class="ct-toolbarsection ct-toolbarsection-three clearfix" ng-show="component.active.name != 'ct_inner_content' && !isEditing('style-sheet')">
				<?php do_action("oxygen_vsb_toolbar_component_settings"); ?>
			</div>
			...
			<div class="ct-toolbarsection ct-toolbarsection-four ct-toolbar-topright clearfix">
				...
				<div class="ct-toolitem ct-nopaddingright">
					...
					?>
						<a href="<?php echo esc_url( $admin_url );?>" class="ct-wp-button ct-button ct-table-cell ct-greybg ct-backtowp ct-border-right ct-history-button ct-border-left ct-button-centered">
				...
				<div class="ct-panel-tabs-container ct-single-parent-tab">
					<div class="ct-panel-tabs-wrap">
						<div class="ct-panel-tabs">
							<?php do_action("oxygen_vsb_toolbar_components_anchors"); ?>
						</div>
					</div>
				</div>
				<div class="ct-panels">
		 			<?php do_action("oxygen_vsb_toolbar_components_list"); ?>
		 		</div>
			</div>
		</div>
		...
		<div class="ct-toolbar-expanded ct-advanced-settings" ng-if="isActiveActionTab('advancedSettings')">
			<div class="ct-viewport clearfix">
				<div class="ct-panel-tabs-container" 
					...
					<div class="ct-panel-tabs-wrap">
						<div class="ct-panel-tabs">
							<?php do_action("oxygen_vsb_toolbar_advanced_anchors"); ?>
						</div>
						<?php do_action("oxygen_vsb_toolbar_advanced_child_anchors"); ?>
					</div>
				</div>
				<div class="ct-panels clearfix">
					<?php do_action("oxygen_vsb_toolbar_before_advanced_settings"); ?>
			 		<?php do_action("oxygen_vsb_toolbar_advanced_settings"); ?>
				</div>
			</div>
		</div>
		...
		<div class="ct-toolbar-expanded ct-advanced-settings ct-code-editor" ng-if="isActiveActionTab('codeEditor')">
			<div class="ct-viewport clearfix">
				<div class="ct-panel-tabs-container ct-single-parent-tab">
					<div class="ct-panel-tabs-wrap">
						<div class="ct-panel-tabs">
							<?php do_action("oxygen_vsb_toolbar_code_editor_anchors"); ?>
						</div>
					</div>
				</div>
				<div class="ct-panels clearfix">
			 		<?php do_action("oxygen_vsb_toolbar_code_editor_settings"); ?>
				</div>
			</div>
		</div>
		<!-- .ct-code-editor -->
		...
		<div class="ct-toolbar-expanded ct-svg-icons-list" ng-if="isActiveActionTab('SVGIcons')">
			<div class="ct-viewport">
				<div class="ct-viewport-inner clearfix">
					<?php do_action("oxygen_vsb_svg_icons_list"); ?>
				</div>
			</div>
		</div>
		<!-- .ct-svg-icons-list -->
			...
			<div class="ct-viewport clearfix">
				...
				<div class="ct-panels">
		 			<div class="ct-panel" ng-if="isShowTab('settings','page')">
						<?php do_action("oxygen_vsb_toolbar_page_settings"); ?>
					</div>

					<div class="ct-panel" ng-if="isShowTab('settings','global')">
						<?php do_action("oxygen_vsb_toolbar_global_settings"); ?>
					</div>
		 		</div>
			</div>
		...
		<?php 
			 ...
			 * @since 1.4
			 */
			do_action("oxygen_vsb_before_toolbar_close"); 
		?>
...
<?php 
	 ...
	 * @since 1.4
	 */
	do_action("oxygen_vsb_after_toolbar"); 
?>
