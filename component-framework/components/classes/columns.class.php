...
Class OXYGEN_VSB_Columns extends OXYGEN_VSB_Component {
	...
	function __construct( $options ) {
		...
		add_action("oxygen_vsb_toolbar_component_header", array( $this, "columns_settings") );
	}
...
// End OXYGEN_VSB_Columns class
}


// Create section inctance
$section = new OXYGEN_VSB_Columns( array( 
			'name' 		=> 'Columns',
			'tag' 		=> 'ct_columns',
			'params' 	=> array(
					array(
