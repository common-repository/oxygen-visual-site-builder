...
/**
 * OXYGEN_VSB_SVG_Icon Component Class
 * 
 * @since 0.2.1
 */

Class OXYGEN_VSB_SVG_Icon extends OXYGEN_VSB_Component {
	...
	function __construct( $options ) {
		...
		add_action("oxygen_vsb_toolbar_component_settings", array( $this, "icon_settings") );
		add_action("oxygen_vsb_svg_icons_list", 			array( $this, "icons_list") );
	...
	function icon_settings() { ?>
		...
		<div class="ct-toolitem" ng-show="isActiveName('<?php echo esc_attr( $this->options['tag'] ); ?>')">
...
$button = new OXYGEN_VSB_SVG_Icon ( 
