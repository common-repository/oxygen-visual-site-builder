    ...
    return {
        ...
        link: function(scope, element) {
            ...
            scope.addComponent = function(componentName, type, notActivate) {
                ...
                // shortcodes are not available in the free version, show info to upgrade
                if(componentName === 'ct_shortcode') {
                    var content = "<div id='ct-simple-modal-content' class='upgrade_modal_class'><h1>Modal Heading</h1>" +
                    "<p>Please upgrade to the pro version of Oxygen to embed shortcodes</p>" +
